...
from object_detection_241001_002 import yolo_process
...
class CCTVObjectDetection:
    def __init__(self):
        ...
        yolo_process_01 = multiprocessing.Process(
            target=yolo_process,
            args=(self.video_name_01, 32,
                  self.yolo_img_queue_01, self.cctv_to_yolo_queue_01))
        yolo_process_01.start()
